    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-initials {
            ...
            letter-spacing: -6px; /* Para entrelaçar as letras */
            margin-right: -6px; /* Correção do espaçamento negativo */
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="about-text">
                <p>Olá, sou o <strong>Divino José</strong>. Sou estudante de dupla graduação em <strong>Administração e Recursos Humanos</strong>. Não sou uma agência que terceiriza serviços; eu coloco a mão na massa.</p>
        ...
        <div class="card">
            <h2 class="card-title"><i class="fas fa-cogs"></i> Como funciona a parceria?</h2>
            <div class="steps-container">
                <div class="step">
                    <div class="step-icon"><i class="fab fa-whatsapp"></i></div>
                    <h4>1. Alinhamento</h4>
                    <p>Você me chama no WhatsApp e me explica exatamente qual é o seu problema ou prazo.</p>
                </div>
                <div class="step">
                    <div class="step-icon"><i class="fas fa-laptop-code"></i></div>
                    <h4>2. Execução</h4>
                    <p>Eu assumo a responsabilidade e aplico minha técnica administrativa para construir a solução.</p>
                </div>
                <div class="step">
                    <div class="step-icon"><i class="fas fa-check-double"></i></div>
                    <h4>3. Entrega</h4>
                    <p>Você recebe o material pronto, revisado e validado. Rápido e sem burocracia.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <p style="text-align: center; color: var(--text-main); font-size: 16px; margin-bottom: 10px;">Para garantir a agilidade na execução do seu projeto, realize o pagamento via PIX:</p>
            ...
            <a href="https://wa.me/5561995807599?text=Ol%C3%A1%2C%20Divino!%20Gostaria%20de%20iniciar%20um%20projeto%20com%20voc%C3%AA%20e%20j%C3%A1%20vi%20a%20chave%20PIX." class="btn-whatsapp-cta" target="_blank">
        ...
        <footer>
            ...
            Santo Antônio do Descoberto e Região | (61) 99580-7599<br>
    ...
    <div id="modalAbnt" class="modal">
        <div class="modal-content">
            ...
            <h3 style="color: var(--primary); margin-bottom: 15px; font-size: 24px;">Trabalhos e Formatação ABNT</h3>
            <p><strong>Deixe a parte chata comigo.</strong> Eu pesquiso, redijo e estruturo o seu TCC, artigo ou relatório escolar de ponta a ponta.</p>
            <p>Aplico o rigor extremo das normas ABNT (margens, citações, referências automáticas) para que o seu trabalho seja blindado contra reprovações técnicas.</p>
            <a href="https://wa.me/5561995807599?text=Ol%C3%A1%2C%20Divino!%20Preciso%20que%20voc%C3%AA%20fa%C3%A7a/formate%20meu%20trabalho%20acad%C3%AAmico." class="btn-whatsapp-cta" target="_blank">
                <i class="fab fa-whatsapp"></i> Enviar detalhes do trabalho
            </a>
        </div>
    </div>
    ...
    <div id="modalPlanilha" class="modal">
        <div class="modal-content">
            <span class="close" onclick="closeModal('modalPlanilha')">&times;</span>
            <h3 style="color: var(--primary); margin-bottom: 15px; font-size: 24px;">Planilhas & Automação</h3>
            <p><strong>Chega de anotar em cadernos.</strong> Eu construo planilhas dinâmicas que fazem os cálculos pesados por você.</p>
            <p>Precisa de algo mais rápido? Crio integrações onde você preenche um formulário simples no celular e a planilha se atualiza sozinha na nuvem.</p>
            <a href="https://wa.me/5561995807599?text=Ol%C3%A1%2C%20Divino!%20Tenho%20interesse%20no%20servi%C3%A7o%20de%20constru%C3%A7%C3%A3o%20de%20Planilhas." class="btn-whatsapp-cta" target="_blank">
                <i class="fab fa-whatsapp"></i> Explicar o que precisa
            </a>
        </div>
    </div>
    ...
    <div id="modalGestao" class="modal">
        <div class="modal-content">
            <span class="close" onclick="closeModal('modalGestao')">&times;</span>
            <h3 style="color: var(--primary); margin-bottom: 15px; font-size: 24px;">Organização Logística (ADM)</h3>
            <p>Estoque desorganizado é dinheiro jogado fora. Eu analiso o seu fluxo atual e implanto um sistema real de entradas e saídas de produtos.</p>
            <p>Trago a visão corporativa de grandes empresas para o seu comércio, blindando o seu lucro contra o desperdício.</p>
            <a href="https://wa.me/5561995807599?text=Ol%C3%A1%2C%20Divino!%20Preciso%20de%20ajuda%20para%20organizar%20o%20estoque%20do%20meu%20neg%C3%B3cio." class="btn-whatsapp-cta" target="_blank">
                <i class="fab fa-whatsapp"></i> Agendar Consultoria
            </a>
        </div>
    </div>

    <div id="modalCurriculo" class="modal">
        <div class="modal-content">
            <span class="close" onclick="closeModal('modalCurriculo')">&times;</span>
            <h3 style="color: var(--primary); margin-bottom: 15px; font-size: 24px;">Currículo de Elite</h3>
            <p>Como estudante focado em RH, eu sei exatamente por que o seu currículo está sendo ignorado pelos recrutadores.</p>
            <p>Eu reescrevo a sua trajetória, destaco as suas métricas de resultado e insiro as palavras-chave vitais para você vencer a triagem dos robôs e chegar à entrevista.</p>
            <a href="https://wa.me/5561995807599?text=Ol%C3%A1%2C%20Divino!%20Quero%20que%20voc%C3%AA%20reescreva%20o%20meu%20curr%C3%ADculo." class="btn-whatsapp-cta" target="_blank">
                <i class="fab fa-whatsapp"></i> Enviar currículo atual
            </a>
        </div>
    </div>
    ...
    <script>
        // Copy PIX Function
        function copyPix() {
            const pixKeyRaw = "71551137194"; // Chave sem pontuação para o clipboard
            navigator.clipboard.writeText(pixKeyRaw).then(function() {
                ...
                setTimeout(function() {
                    btn.innerHTML = '<i class="far fa-copy"></i> Copiar Chave';
